...
const Modality = () => {
    const modalities = [
        ...
        {
            title: 'Dances',
            imgSrc: '/img/dancas.d037df15.webp',
        ...
        },
        {
            ...
            imgSrc: '/img/eletroestimulacao.71033509.webp',
        ...
        {
            title: 'Beach Tennis',
            imgSrc: '/img/beach-tennis.7077e3c8.webp',
        ...
        {
            title: 'Volleyball',
            imgSrc: '/img/volei.5cf2a247.webp',
                    ...
                    <div className={styles.infoBox}>
                        ...
                        >
                            ...
                            <Image
                                ...
                                src="/img/black-right-arrow.8d0ed5f9.svg"
                            />
                        </a>
                    </div>
                    <div>
                        ...
                        <div className={styles.navigationButtons}>
                            <button type="button" className={`${styles.paginationButton} ${styles.prevButton}`}>
                                <Image
                                    ...
                                    height="24"
                                    style={{ color: 'transparent' }}
                                    src="/img/black-left-arrow.7d412d02.svg"
                                />
                            </button>
