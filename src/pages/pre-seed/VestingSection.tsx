...
import { faCalendarAlt, faClock, faLock, faPiggyBank, faShieldAlt, faWallet, faChartLine } from '@fortawesome/free-solid-svg-icons';
import styles from '@/styles/components/common/VestingSection.module.css';
